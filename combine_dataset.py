...
out_path = "/home/oq55olys/Projects/neural_rendering/4dbase/LiDAR4D/log/kitti360_lidar4d_f1538_release/simulation/points/"
...
dataset_intensity_dir = dataset_dir + "intensity3/"
...
if not os.path.exists(out_path):
  ...
  for sub_path in sub_paths:
      ...
      #add /points/
      points_path = path + "/simulation00/points/"
...
for pcd_file, pcd_file_bin in zip(pcd_files, pcd_bin_files):
    ...
    depth_bin, pano_bin = lidar_to_pano_with_intensities(points_bin, 64, 1024, [2.02984126984, 11.0317460317, -8.799812, 16.541], max_depth=80, z_offsets = [-0.202, -0.121])
    ...
    overwrite_cross_pixels(img, rgb_img, 0, img)
