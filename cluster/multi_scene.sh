...
for SCENE_ID in    
  ...
  do
    ...
    sbatch --job-name=0000_${SEQ_ID}_combined_imask_nmask cluster/cluster_train.sh $SEQ_ID "combined_imask_nmask" $tag "laser_strength near_range_threshold near_range_factor distance_scale near_offset distance_fall" "0.1 0.05 0.05 0.005 0.1 0.1" "True" 3 0.2 $SCENE_ID
  done
done